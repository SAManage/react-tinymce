...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangIsEqual = __webpack_require__(14);
	
	var _lodashLangIsEqual2 = _interopRequireDefault(_lodashLangIsEqual);
	
	var _lodashLangClone = __webpack_require__(39);
	
	var _lodashLangClone2 = _interopRequireDefault(_lodashLangClone);
	
	var _helpersUuid = __webpack_require__(54);
	
	var _helpersUuid2 = _interopRequireDefault(_helpersUuid);
	
	var _helpersUcFirst = __webpack_require__(55);
	...
	var TinyMCE = (function (_React$Component) {
	  ...
	  function TinyMCE() {
	    ...
	    return _temp = _get(Object.getPrototypeOf(TinyMCE.prototype), 'constructor', this).apply(this, args), this._init = function (config, content) {
	      if (_this._isInit) {
	        _this._remove();
	      }
	
	      // hide the textarea that is me so that no one sees it
	      (0, _reactDom.findDOMNode)(_this).style.hidden = 'hidden';
	      ...
	      tinymce.EditorManager.execCommand('mceRemoveEditor', true, _this.id);
	      _this._isInit = false;
	    }, _temp;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayCopy = __webpack_require__(41),
	    ...
	    initCloneArray = __webpack_require__(49),
	    initCloneByTag = __webpack_require__(50),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bufferClone = __webpack_require__(51);
